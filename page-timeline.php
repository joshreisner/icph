...
<div class="timeline_mask">
	<ul id="timeline">
		<li class="progressive overview">
			<div class="upper">
				<h1>1890&dash;1928</h1>
	...
	<ul id="slider">
		<li class="early_ny">
			1650 <span>Early New York</span>
		</li>
		<li class="nineteenth">
			1830 <span>19th Century</span>
		</li>
		<li class="progressive active">
			1890 <span>The Progressive Era</span>
		</li>
		<li class="great_depression">
			1929 <span>Great Depression</span>
		</li>
		<li class="today">
