...
$nav_array = array();
$parent = get_post($post->post_parent);
$siblings = get_posts('post_type=attachment&post_status=any&post_mime_type=image&orderby=menu_order&order=ASC&post_parent=' . $post->post_parent . '&exclude=' . get_post_thumbnail_id($post->post_parent));
