...
<style type="text/css">
	#header { display: none; }
	#slider_policy_wrapper { display: none; }
	
	body.maps div.zoom.in { top: 20px; }
	body.maps div.zoom.out { top: 60px; }
	body.maps div#description { top: 20px; }
</style>
...
foreach ($eras as $era) {
	...
	<script>
		...
		<?php if ($era->post_name == 'progressive') {?>
